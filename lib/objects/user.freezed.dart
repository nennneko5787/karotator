...
mixin _$AuthUser {
 ...
 String get emailHash; bool get hasPassword; bool get twoFactorEnabled; List<String> get linkedOAuthProviders; bool get isPrivate; bool get isBotAccount; bool get isParodyAccount; bool get adminForceParody; bool get adminForceBot; bool get adminForceR18; bool get adminForceHidden; int? get adminForceProfileMinimumAge; int? get adminForceProfileMaximumAge;@OfficialMarkListConverter() List<OfficialMark> get officialMark; bool get isAdmin; bool get isBanned; bool get isRestricted; String? get banReason; DateTime? get bannedUntil; DateTime? get birthday; String? get displayBirthday; String get birthdayVisibility; bool get birthdayBalloonsEnabled; String get gender; DateTime? get createdAt; int get followersCount; int get followingCount; int get postsCount; int get points; int get experience; bool get levelEnabled; bool get isPremium; DateTime? get premiumUntil;// ---- 公開範囲 ----
 bool get hideProfileFromMinors; int? get profileMinimumAge; int? get profileMaximumAge; String get onlineStatus; String get onlineStatusVisibility; bool get questionsEnabled; bool get giftsEnabled; bool get showLikedPosts; bool get showReadReceipts;// ---- DM ----
 bool get directMessagesEnabled;/// 誰から DM を受けるか。`EVERYONE` / `FOLLOWING` など。
 String get dmRequestPolicy;// ---- タイムラインの見え方 ----
 bool get showR18Content; bool get showHiddenPosts; bool get showBotAccounts; bool get showParodyAccounts; bool get showReactions; bool get showRepliesInTimeline; bool get showRekarotsInTimeline; bool get hideUnfollowedRekarotsInTimeline; List<String> get mutedKeywords;// ---- 投稿の既定値 ----
 bool get defaultExcludeReplyTargets;// ---- 通知 ----
 bool get notifyLikes; bool get notifyReplies; bool get notifyRekarots; bool get notifyQuotes; bool get notifyMentions; bool get notifyFollows; bool get notifyReactions; bool get notifyDMs; bool get notifyBoardActivity; bool get notifyNewsOnLaunch; bool get notificationMuteNewAccounts; bool get notificationMuteNoAvatar; bool get notificationMuteNonFollowers; bool get notificationMuteNonFollowing;// ---- 規約 ----
 bool get legalQuizPassed;/// 最後に読んだ利用規約のバージョン。文字列で比較される。
 String? get legalNoticeSeenVersion;// ---- 課金 ----
